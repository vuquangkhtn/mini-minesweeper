...
export const levelSelector = (state: AppState): LevelType => state.gameState.level;
export const gameStatusSelector = (state: AppState): GameStatusType => state.gameState.status;

export const selectedCellsSelector = (state: AppState): Key[] => state.gameState.selectedCells;
